...
# APIの検査（自分で中身を空にする）
for f in tests/t-bmove.js tests/t-bcount.js tests/t-kin.js tests/t-amt.js tests/t-dashamt.js; do 出す "$f"; done
...
node tests/da-seed.mjs  >/dev/null 2>&1; 出す tests/t-dashamtui.mjs
